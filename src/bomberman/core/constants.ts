...
export const BOMBERMAN_MAX_FRAMES = 400;
export const BOMBERMAN_BLAST_RANGE = 1;
export const BOMBERMAN_BOMB_LIMIT = 1;
export const BOMBERMAN_PLAYER_SPEED_UNITS = 100;
export const BOMBERMAN_SPEED_ITEM_BONUS = 5;

export const BOMBERMAN_ITEM_DROP_CHANCE_BY_LEVEL = {
	NONE: 0,
	FIRST_QUARTILE: 0.08,
...
export const BOMBERMAN_ITEM_SPRITES = {
	blastRange: {
		x: 0,
		y: 0,
		width: 16,
